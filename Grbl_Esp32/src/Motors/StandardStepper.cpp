...
namespace Motors {
    ...
    void StandardStepper::init_step_dir_pins() {
        ...
        //chatgpt code :
//         if (_axis_index == 0) {
//     _invert_dir_pin = true;   // flip X direction
// } else {
//     _invert_dir_pin = false;  // leave others normal
// }
        _invert_dir_pin  = bitnum_istrue(dir_invert_mask->get(), _axis_index);   // actual code
